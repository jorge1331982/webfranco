     ...
     <form wire:submit.prevent="rendi">
         <div class="row">
             <div class="col-sm-6 form-group">
                <input type="date"  placeholder="Fecha" wire:model="fecha" required class="form-control">
             </div>
             <div class="col-sm-6 form-group">
             ...
             <div class="col-sm-6 form-group">
                <input type="text"  placeholder="Ingrese Costo Gasolina por (Litro)" wire:model="costogas" required class="form-control">
             </div>
             <div class="col-sm-6 form-group">
                <input type="text"  placeholder="Cantidad de  litros Cargados" wire:model="litros" required class="form-control">
             </div>
             <div class="col-sm-6 form-group">
                 <label for="kk">Seleccione Unidad</label>
                <select  wire:model="gasolina_id" class="form-control" id="kk">

                    @foreach($ret as $t)
                       <option value="{{$t->id}}" >{{$t->vehiculo}}</option>
                    @endforeach
                </select>
             </div>
         </div>
