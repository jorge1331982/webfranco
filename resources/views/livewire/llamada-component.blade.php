<div class="container">
  ...
  <form  wire:submit.prevent="dor">
    <div class="row">
        <div class="col-sm-6 form-group">
            <input type="date" placeholder="ingrese fecha" wire:model="fecha" required class="form-control">
        </div>
        <div class="col-sm-6 form-group">
            <input type="text" placeholder="Empresa" wire:model="empresa" required class="form-control">
        </div>
        <div class="col-sm-6 form-group">
            <input type="text" placeholder="Contacto" wire:model="contacto" required class="form-control">
        </div>
        <div class="col-sm-6 form-group">
            <input type="text" placeholder="Telefono" wire:model="telefono" required class="form-control">
        </div>
        <div class="col-sm-6 form-group">
            <input type="email" placeholder="Correo" wire:model="correo" required class="form-control">
        </div>
        <div class="col-sm-6 form-group">
            <input type="text" placeholder="Medio contacto" wire:model="medio" required class="form-control">
        </div>
        <div class="col-sm-12 form-group">
            <input type="text" placeholder="Requerimientos" wire:model="requerimiento" required class="form-control">
        </div>
        <div class="col-sm-6 form-group">
            <input type="text" placeholder="Comentarios" wire:model="comentario" required class="form-control">
        </div>
        <div class="col-sm-6 form-group">
           <select wire:model="asesor" class="form-control">
