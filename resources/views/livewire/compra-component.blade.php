<div class="container">
    ...
    <form wire:submit.prevent="rex">
        <div class="row">
            ...
            <div class="form-group col-md-6">
                <input type="text" placeholder="Ingrese Orden de Compra (generar uno)" wire:model="Ocompra" required class="form-control">
            </div>
            ...
            <div class="form-group col-md-6">
                <input type="text" placeholder="Precio Total" wire:model="precio" required class="form-control">
            </div>
            <div class="form-group col-md-6">
