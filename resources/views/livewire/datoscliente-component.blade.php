<div class="container">
    ...
    <form wire:submit.prevent="rote" >

        <div class="row">
            <div class="form-group col-md-6">
               <input type="date" placeholder="ingrese Fecha" wire:model="fechaB" required class="form-control">
            </div>
            <div class="form-group col-md-6">
             <input type="text" placeholder="Nombre Asesor" wire:model="asesor" required class="form-control">
          </div>
            <div class="form-group col-md-6">
             <input type="mail" placeholder="Orden Produccion" wire:model="ordenP" required class="form-control">
          </div>
          <div class="form-group col-md-6">
             <input type="text" placeholder="Factura" wire:model="factura" required class="form-control">
          </div>
          <div class="form-group col-md-12">
             <input type="text" placeholder="Metodo de Pago" wire:model="metodoP" required class="form-control">
          </div>
          <div class="form-group col-md-12">
             <input type="text" placeholder="Forma de Pago" wire:model="formaP" required class="form-control">
          </div>
          <div class="form-group col-md-6">
             <input type="text" placeholder="Uso de CFDI" wire:model="cfdi" required class="form-control">
          </div>
          <div class="form-group col-md-6">
             <input type="text" placeholder="Precio Neto" wire:model="precioN" required class="form-control">
          </div>

          <div class="form-group col-md-6">
            <select  wire:model="dato_id" class="form-control">
                <option>Seleccione Cliente </option>
                @foreach ($rou as $k)
                <option value="{{$k->id}}">{{$k->nombreC}}</option>
                @endforeach
            </select>
          </div>
          <div class="form-group col-md-6">
            <input type="text" placeholder="Producto" wire:model="producto" required class="form-control">
         </div>
        </div>
