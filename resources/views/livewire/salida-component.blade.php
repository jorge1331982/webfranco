<div class="container">
            ...
            <form wire:submit.prevent="dass">
                <div class="form-group">
                    <input type="date" placeholder="Ingrese fecha" wire:model="fecha" class="form-control" required>
                </div>
                <div class="form-group">
                    <input type="text" placeholder="Nombre de Quien Recibe Unidad" wire:model="quien_recibe" class="form-control" required>
                </div>
                <div class="form-group">
                    <input type="text" placeholder="Nombre de Quien Entrega Unidad" wire:model="quien_entrega" class="form-control" required>
                </div>
                <div class="form-group">
                    <input type="text" placeholder="Nombre Responsable De Revision de Calidad" wire:model="revision_calidad" class="form-control" required>
                </div>
                <div class="form-group">
                    <input type="text" placeholder="Nombre Responsable del VoBo" wire:model="vobo_salida" class="form-control" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <select wire:model="produccion_id" class="form-control" required>
                        <option selected>Folio de Registro de Check In</option>
                        @foreach($rex as $n)
                        <option value="{{$n->id}}">{{ $n->folio}}</option>
                    @endforeach
                      </select>
                </div>
