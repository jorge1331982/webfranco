<div class="container">
   ...
   <form wire:submit.prevent="tejes">
       <div class="row">
           <div class="form-group col-md-6">
              <input type="text" placeholder="Ingrese Nombre del Producto" required class="form-control" wire:model="nombre">
           </div>
           <div class="form-group col-md-6">
            <input type="text" placeholder="Ingrese Categoria del Producto" required class="form-control" wire:model="cate">
         </div>
       </div>
       <div class="row">
           <div class="form-group col-md-6">
            <input type="text" placeholder="Ingrese Sku del Producto" required class="form-control" wire:model="sku">
           </div>
           <div class="form-group col-md-6">
            <input type="text" placeholder="Ingrese Cantidad del Producto" required class="form-control" wire:model="stock">
           </div>
           <div class="form-group col-md-12">
            <input type="text" placeholder="Ingrese Medida del Producto" required class="form-control" wire:model="medida">
           </div>
