...
<h1 class="text-center text-green font-weight-bold mb-5 display-4 fst-italic" id="titulo">REGISTRO PROVEEDORES ALMACEN</h1>


<livewire:scripts>
@livewire('entrada-component')
