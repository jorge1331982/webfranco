...
<h1 class="text-center font-weight-bold mb-5 display-4 fst-italic" id="titulo" style="color:rgb(98, 233, 98)">REGISTRO CONTROL PRODUCCION ALCHICHICA</h1>


<livewire:scripts>
@livewire('siguiente-component')
@livewireStyles
