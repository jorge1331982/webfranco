...
<body>
   ...
   <p style="font-size:8;margin-left:6; " class="font-weight-bold">Por medio de la presente someto a su apreciable consideracion la cotizacion para:</p>
      <div style="float:right;margin-right:130;margin-top:19;line-height : 5px; font-size:9">
...
<br />
  ...
  <div>
   ...
   <p style="text-align: center; margin-left:2;margin-right:2;">VENTANAS EN COPETE PARA NISSAN NP300 DE 30X40 (PAR).${{$nota->sugeridos}} pesos MAS IVA</p>
</div>
